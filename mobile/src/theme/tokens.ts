...
const SHARED = {
  ...
  // Type — use the platform system font so `fontWeight` renders true bold/
  // semibold on every device. (Custom static Inter weights don't combine
  // with fontWeight in Expo Go, which made headings/numbers look off.)

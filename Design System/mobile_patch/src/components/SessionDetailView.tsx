    ...
    <ScrollView style={{ flex: 1, backgroundColor: t.bg }} contentContainerStyle={{ padding: t.screenPad, paddingBottom: 28 }}>
      ...
      <Card padding={20} style={{ marginTop: 8 }}>
        ...
        <Text style={{
          ...
          letterSpacing: -0.7, fontVariant: ['tabular-nums'], lineHeight: 38,
        }}>
            ...
            <Card key={`${p.result.id}-${idx}`} onPress={() => onPhotoPress(idx)} padding={12} style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View style={{ position: 'relative' }}>
                ...
                <View style={{
                  ...
                  <Text style={{ color: '#fff', fontFamily: t.font, fontWeight: t.fw.bold, fontSize: 11, fontVariant: ['tabular-nums'] }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                {typeof r.actualCost === 'number' ? (
                  <View style={{ alignItems: 'flex-end' }}>
                    ...
                    <Text style={{ fontFamily: t.font, fontWeight: t.fw.bold, fontSize: t.fs.h2, color: t.success, marginTop: 2, fontVariant: ['tabular-nums'] }}>€{r.actualCost.toFixed(0)}</Text>
                  </View>
                ) : null}
              </View>
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={{
        ...
        color: t.fg1, marginTop: 6, fontVariant: ['tabular-nums'],
      }}>{value}</Text>
    </View>
  );
}
